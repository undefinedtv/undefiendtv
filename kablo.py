...
def get_canli_tv_m3u():
    ...
    headers = {
        ...
        "Authorization": "Bearer eyJhbGciOiJIUzI1NiJ9..y3BXI873cntZ1PfgAfCX3lYYjffSL0neMPTfzVl7OEk"
    }
    ...
    try:
        ...
        for channel in channels:
            ...
            if hls_url:
                # wmsAuthSign parametresini regex ile çıkar
                match = re.search(r'wmsAuthSign=(.*?)(?:$|&)', hls_url)
                if match:
                    current_token = match.group(1)
                    print(f"🔑 Güncel token alındı: {current_token[:30]}...")
                    
                    # Token'ı dosyaya kaydet (PHP kodundaki gibi)
                    with open("token.txt", "w", encoding="utf-8") as token_file:
                        token_file.write(current_token)
                    break
